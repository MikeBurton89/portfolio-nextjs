...
const iconLinks = [{
    ...
    data_tippy_content: "@facebook_handle"
},
{
    id: 1,
    title: 'Twitter',
    ...
    data_tippy_content: "@twitter_handle"
},
{
    id: 0,
    title: 'Github',
    ...
    data_tippy_content: "@github_handle"
},
{
    id: 0,
    title: 'Instagram',
    ...
    data_tippy_content: "@instagram_handle"
}]
                    ...
                    <div className="max-w-4xl opacity-75 flex items-center h-auto lg:h-full flex-wrap mx-auto my-0 lg:my-32">
                        ...
                        <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                            ...
                            <div className="p-4 md:p-12 text-center lg:text-left">
                                ...
                                <h1 className="text-3xl font-bold pt-8 lg:pt-0">Michele Puricelli</h1>
                                ...
                                <p className="pt-8 text-sm">I develop websites for a living. From wireframe to finished products, from your idea to a website.</p>

                                <div className="pt-12 pb-8">
                                    <button className="bg-dark-grey hover:bg-green text-white font-bold py-2 px-4 rounded-full">
                                        Get In Touch
                                    </button>
                                </div>
                        ...
                        {width > 1023 && <div className="w-full lg:w-2/5">
                            <Fade top>
