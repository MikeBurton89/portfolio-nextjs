...
const Contacts = () => {
    ...
    return (
        <LayoutContainer >
            <div className="max-w-4xl flex items-center h-auto lg:h-full flex-wrap mx-auto my-0 lg:my-32">
                ...
                <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                    ...
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <p className="pt-8 text-sm">I develop cool website using the latest technologies</p>

                        <div className="pt-12 pb-8">
                            <button className="bg-green hover:bg-green text-white font-bold py-2 px-4 rounded-full">
                                Get In Touch
                            </button>
                        </div>
